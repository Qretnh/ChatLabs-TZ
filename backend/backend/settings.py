...
SECRET_KEY = 'django-insecure-8(aj_us6&*5jgtugmdwzy9btv%__ts23y(_b93$#%-$t#fzmjg'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('DATABASE'),                               # Имя сервиса в Docker Compose
...
CELERY_BEAT_SCHEDULE = {
    'check_tasks_due': {
        'task': 'TODO.tasks.check_and_notify_tasks',
